...
def coalition_score(coalition_, XY):
    ...
    return ((np.linalg.norm(avg_coalition - avg_opposition, ord=2)-0.11884543093915637)/(0.7848325253103648 - 0.11884543093915637) + 1)**2/((avg_dist - 0.9082616340543562)/(0.9416345219593429 - 0.9082616340543562) + 1)
